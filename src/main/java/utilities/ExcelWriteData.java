...
public class ExcelWriteData {
	...
	public static void main(String[] args) {
		...
		try {
			writeDataInExcel3("contacts", "Email", createEmail());
			writeDataInExcel3("contacts", "First_Name", firstName());
			writeDataInExcel3("contacts", "Last_Name", lastName());
			writeDataInExcel3("contacts", "Phone_Number", phoneNumber());
...
//		System.out.println(phoneNumber());
	...
	public static List<String> createEmail() {
...
//}
	...
	public static void writeDataInExcel3(String sheetName, String columnName, List<String> dataToWrite)
		...
		String path = System.getProperty("user.dir") + "\\src\\test\\resources\\ExcelSheets\\Standard_Sheet_07.xlsx";
