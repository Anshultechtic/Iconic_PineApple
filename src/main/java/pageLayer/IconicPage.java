...
public class IconicPage extends UtilClass {
	...
	public void enterusername(String email) {
		...
		user_name.sendKeys("Techtic1");
	}

	public void enterpassword(String email) {

		password.sendKeys("Aquaffect319269411");
	}
	...
	@FindBy(xpath = "(//*[@id='menu-magento-catalog-catalog']//a)[1]")
	private WebElement catalog_menu;
	...
	@FindBy(xpath = "//*[@data-ui-id='menu-magento-catalog-catalog-products']")
	...
	public void sendDataInSearchBox(String data) {
